...
#para el webscraping  
            ...
            #Si pos1 no encuentra información en la posicion donde se encuentra returna un negativo, en caso contrario envia numero positivo...
        ...
        if i==266:
            ...
            print ("\nEl tiempo de ejecucion del secuencial fue :",tiempo_ejecucion) #En segundos
            
                        
            procucts = WordCloud(width = 800, height = 800,
                      background_color = 'white',
                      
                                  min_font_size = 10).generate(productos_Agricolas)
            procucts.to_file('Productos agricolas secuencial.png')
            
            industrie = WordCloud(width = 800, height = 800,
                                  background_color = 'white',
                                  
                                  min_font_size = 10).generate(productos_Industriales)
            industrie.to_file('Productos industriales secuencial.png')
